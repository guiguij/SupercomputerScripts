...
$StarCcmRunVersionPath -rsh /opt/pbs/default/bin/pbs_tmrsh -batch $BatchFlagCommand -machinefile $PBS_NODEFILE -mpi platform  -batch-report -np $PBS_NCPUS -power -licpath 1999@59.100.207.26 -classpath /short/uo95/gj5914/JarFilesPOI3.15ForBasicPPT/ $SimulationPath > ${PBS_O_WORKDIR}/sim.log 
echo
echo "================ job done ==================="
echo "Date:   $(date)"
echo "retval: $retval"
